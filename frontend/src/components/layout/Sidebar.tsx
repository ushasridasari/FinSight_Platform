...
import { LayoutDashboard, TrendingUp, BarChart2, BrainCircuit, Briefcase, Star, LogOut, FlaskConical, Target, ShieldCheck, PieChart } from 'lucide-react'
...
const links = [
  ...
  { to: '/ai-portfolio', label: 'AI Portfolio', icon: PieChart },
  { to: '/ai-risk',      label: 'AI Risk',      icon: ShieldCheck },
]
